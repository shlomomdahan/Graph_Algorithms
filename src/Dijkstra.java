...
public class Dijkstra {
    ...
    public static Dictionary[] dijkstra(Graph g, Vertex staringVertex) {
        ...
        distances.put(staringVertex.getData(), 0);
    ...
    public static void main(String[] args) {
        ...
        shortestPathBetween(testGraph, a, e);
    }
}
